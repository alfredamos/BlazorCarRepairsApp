        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    AssignBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignedTickets", x => new { x.TicketId, x.TechnicianId });
                    table.ForeignKey(
                        name: "FK_AssignedTickets_Technicians_TechnicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignedTickets_TechnicianId",
